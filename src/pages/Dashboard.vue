...
<!--        {{user.role.id}}-->
    <q-expansion-item
      expand-separator
      icon="help"
      label="Описание системы управления показателями (СУП)"
      class="q-mb-md"
    >
      <q-card>
        <q-card-section>
          Система управления показателями (СУП) - онлайн сервис позволяющий вести документооборот внутри одной компании, создавать и контролировать выполнение задач сотрудниками, отслеживать время работы, качество выполнения задач, контролировать операционные показатели бизнеса.<br><br>
          Система выполняет функцию контролера и сигнализирует пользователю о необходимости выполнения конкретных действий. <br><br>
          Система позволяет взаимодействовать с субподрядными организациями (внештатными сотрудниками), ежедневно планировать и контролировать выполнение работ субподрядной организацией (внештатными сотрудниками). СУП автоматически определяет процент выполненных работ на текущую дату, а также остаток товаров на объекте, не позволяет допустить ошибки при расчете и оплате выполненных работ.
        </q-card-section>
      </q-card>
    </q-expansion-item>
